...
save_grid_plot <- function(filename, heatmap_plot, pie_plot, width = 12, height = 6, dpi = 300) {
  # Abrir un dispositivo gráfico para guardar el archivo
  ggsave(
    filename = filename,
    plot = grid.arrange(
      heatmap_plot$gtable,  # Heatmap generado por pheatmap
      pie_plot,             # Pie chart generado por ggplot
      ncol = 2              # Configuración de disposición (dos columnas)
    ),
    width = width,
    height = height,
    dpi = dpi,
